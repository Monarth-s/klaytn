...
Klaytn supports multiple transaction types to efficiently trigger VINI transfer or contract execution.
...
Functions and variables related to Block and Transaction are defined in the files listed below.
  ...
  - tx_internal_data_value_transfer.go: implements the transaction sending VINI to an EOA
  - tx_internal_data_value_transfer_memo.go: implements the transaction sending VINI to an EOA with data
