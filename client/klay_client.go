...
func (ec *Client) BlockByHash(ctx context.Context, hash common.Hash) (*types.Block, error) {
	return ec.getBlock(ctx, "vini_getBlockByHash", hash, true)
}
...
func (ec *Client) BlockByNumber(ctx context.Context, number *big.Int) (*types.Block, error) {
	return ec.getBlock(ctx, "vini_getBlockByNumber", toBlockNumArg(number), true)
}
...
func (ec *Client) HeaderByHash(ctx context.Context, hash common.Hash) (*types.Header, error) {
	var head *types.Header
	err := ec.c.CallContext(ctx, &head, "vini_getBlockByHash", hash, false)
	if err == nil && head == nil {
		err = klaytn.NotFound
	}
	return head, err
...
func (ec *Client) HeaderByNumber(ctx context.Context, number *big.Int) (*types.Header, error) {
	var head *types.Header
	err := ec.c.CallContext(ctx, &head, "vini_getBlockByNumber", toBlockNumArg(number), false)
	if err == nil && head == nil {
		err = klaytn.NotFound
	}
	return head, err
...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	err = ec.c.CallContext(ctx, &json, "vini_getTransactionByHash", hash)
	if err != nil {
...
func (ec *Client) TransactionSender(ctx context.Context, tx *types.Transaction, block common.Hash, index uint) (common.Address, error) {
	...
	if err = ec.c.CallContext(ctx, &meta, "vini_getTransactionByBlockHashAndIndex", block, hexutil.Uint64(index)); err != nil {
...
func (ec *Client) TransactionCount(ctx context.Context, blockHash common.Hash) (uint, error) {
	...
	err := ec.c.CallContext(ctx, &num, "vini_getBlockTransactionCountByHash", blockHash)
	return uint(num), err
}
...
func (ec *Client) TransactionInBlock(ctx context.Context, blockHash common.Hash, index uint) (*types.Transaction, error) {
	var json *rpcTransaction
	err := ec.c.CallContext(ctx, &json, "vini_getTransactionByBlockHashAndIndex", blockHash, hexutil.Uint64(index))
	if err != nil {
		return nil, err
	}
	if json == nil {
...
func (ec *Client) TransactionReceipt(ctx context.Context, txHash common.Hash) (*types.Receipt, error) {
	var r *types.Receipt
	err := ec.c.CallContext(ctx, &r, "vini_getTransactionReceipt", txHash)
	if err == nil {
		if r == nil {
			return nil, klaytn.NotFound
		}
...
func (ec *Client) SyncProgress(ctx context.Context) (*klaytn.SyncProgress, error) {
	var raw json.RawMessage
	if err := ec.c.CallContext(ctx, &raw, "vini_syncing"); err != nil {
		return nil, err
	}
...
func (ec *Client) BalanceAt(ctx context.Context, account common.Address, blockNumber *big.Int) (*big.Int, error) {
	...
	err := ec.c.CallContext(ctx, &result, "vini_getBalance", account, toBlockNumArg(blockNumber))
...
func (ec *Client) StorageAt(ctx context.Context, account common.Address, key common.Hash, blockNumber *big.Int) ([]byte, error) {
	...
	err := ec.c.CallContext(ctx, &result, "vini_getStorageAt", account, key, toBlockNumArg(blockNumber))
	return result, err
}
...
func (ec *Client) CodeAt(ctx context.Context, account common.Address, blockNumber *big.Int) ([]byte, error) {
	var result hexutil.Bytes
	err := ec.c.CallContext(ctx, &result, "vini_getCode", account, toBlockNumArg(blockNumber))
	return result, err
}
...
func (ec *Client) NonceAt(ctx context.Context, account common.Address, blockNumber *big.Int) (uint64, error) {
	...
	err := ec.c.CallContext(ctx, &result, "vini_getTransactionCount", account, toBlockNumArg(blockNumber))
...
func (ec *Client) FilterLogs(ctx context.Context, q klaytn.FilterQuery) ([]types.Log, error) {
	...
	err := ec.c.CallContext(ctx, &result, "vini_getLogs", toFilterArg(q))
	return result, err
}
...
func (ec *Client) PendingBalanceAt(ctx context.Context, account common.Address) (*big.Int, error) {
	var result hexutil.Big
	err := ec.c.CallContext(ctx, &result, "vini_getBalance", account, "pending")
	return (*big.Int)(&result), err
}
...
func (ec *Client) PendingStorageAt(ctx context.Context, account common.Address, key common.Hash) ([]byte, error) {
	var result hexutil.Bytes
	err := ec.c.CallContext(ctx, &result, "vini_getStorageAt", account, key, "pending")
	return result, err
}
...
func (ec *Client) PendingCodeAt(ctx context.Context, account common.Address) ([]byte, error) {
	var result hexutil.Bytes
	err := ec.c.CallContext(ctx, &result, "vini_getCode", account, "pending")
	return result, err
}
...
func (ec *Client) PendingNonceAt(ctx context.Context, account common.Address) (uint64, error) {
	var result hexutil.Uint64
	err := ec.c.CallContext(ctx, &result, "vini_getTransactionCount", account, "pending")
	return uint64(result), err
}
...
func (ec *Client) PendingTransactionCount(ctx context.Context) (uint, error) {
	var num hexutil.Uint
	err := ec.c.CallContext(ctx, &num, "vini_getBlockTransactionCountByNumber", "pending")
	return uint(num), err
}
...
func (ec *Client) CallContract(ctx context.Context, msg klaytn.CallMsg, blockNumber *big.Int) ([]byte, error) {
	...
	err := ec.c.CallContext(ctx, &hex, "vini_call", toCallArg(msg), toBlockNumArg(blockNumber))
	if err != nil {
		return nil, err
	}
	return hex, nil
...
func (ec *Client) PendingCallContract(ctx context.Context, msg klaytn.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
	err := ec.c.CallContext(ctx, &hex, "vini_call", toCallArg(msg), "pending")
	if err != nil {
		return nil, err
	}
	return hex, nil
...
func (ec *Client) SuggestGasPrice(ctx context.Context) (*big.Int, error) {
	var hex hexutil.Big
	if err := ec.c.CallContext(ctx, &hex, "vini_gasPrice"); err != nil {
		return nil, err
	}
...
func (ec *Client) EstimateGas(ctx context.Context, msg klaytn.CallMsg) (uint64, error) {
	...
	err := ec.c.CallContext(ctx, &hex, "vini_estimateGas", toCallArg(msg))
	if err != nil {
		return 0, err
	}
...
func (ec *Client) SendTransaction(ctx context.Context, tx *types.Transaction) error {
	...
	//	return err
	//}
	//return ec.c.CallContext(ctx, nil, "vini_sendRawTransaction", common.ToHex(data))
}
...
func (ec *Client) SendRawTransaction(ctx context.Context, tx *types.Transaction) (common.Hash, error) {
	...
	if err := ec.c.CallContext(ctx, &hex, "vini_sendRawTransaction", hexutil.Encode(data)); err != nil {
		return common.Hash{}, err
	}
...
func (ec *Client) SendUnsignedTransaction(ctx context.Context, from common.Address, to common.Address, gas uint64, gasPrice uint64, value *big.Int, data []byte, input []byte) (common.Hash, error) {
	...
	if err := ec.c.CallContext(ctx, &hex, "vini_sendTransaction", toSendTxArgs(unsignedTx)); err != nil {
		return common.Hash{}, err
	}
	hash := common.BytesToHash(hex)
	return hash, nil
...
func (ec *Client) BlockNumber(ctx context.Context) (*big.Int, error) {
	var result hexutil.Big
	err := ec.c.CallContext(ctx, &result, "vini_blockNumber")
	return (*big.Int)(&result), err
}
...
func (ec *Client) ChainID(ctx context.Context) (*big.Int, error) {
	...
	var result hexutil.Big
	err := ec.c.CallContext(ctx, &result, "vini_chainID")
	if err == nil {
...
func (ec *Client) CreateAccessList(ctx context.Context, msg klaytn.CallMsg) (*types.AccessList, uint64, string, error) {
	...
	if err := ec.c.CallContext(ctx, &result, "vini_createAccessList", toCallArg(msg)); err != nil {
		return nil, 0, "", err
	}
