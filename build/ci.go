...
import (
	...
	"github.com/Monarth-s/klaytn/utils/build"
)
...
func buildFlags(env build.Environment) (flags []string) {
	...
	if env.Commit != "" {
		...
		ld = append(ld, "-X", "github.com/Monarth-s/klaytn/cmd/utils/nodecmd.gitCommit="+env.Commit)
	}
	if env.Tag != "" {
		ld = append(ld, "-X", "github.com/Monarth-s/klaytn/cmd/utils/nodecmd.gitTag="+env.Tag)
	}
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.klaytn", "-v", "github.com/Monarth-s/klaytn/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/Monarth-s/klaytn/mobile")
