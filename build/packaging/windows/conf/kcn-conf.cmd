...
set RPC_API="vini" &:: available apis: admin,debug,vini,eth,miner,net,personal,rpc,txpool,web3
set RPC_PORT=8551
...
set WS_API="vini" &:: available apis: admin,debug,vini,eth,miner,net,personal,rpc,txpool,web3
set WS_ADDR="0.0.0.0"
set WS_PORT=8552
set WS_ORIGINS="*"
