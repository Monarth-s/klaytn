...
import (
	...
	"github.com/Monarth-s/klaytn/node/sc"
...
const (
	ClientIdentifier = "vini" // Client identifier to advertise over the network
...
func DefaultNodeConfig() node.Config {
	...
	cfg.HTTPModules = append(cfg.HTTPModules, "vini", "shh", "eth")
	cfg.WSModules = append(cfg.WSModules, "vini", "shh", "eth")
