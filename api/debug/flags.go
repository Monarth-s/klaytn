...
var (
	verbosityFlag = &cli.IntFlag{
		...
		EnvVars:  []string{"VINITN_VERBOSITY"},
	...
	backtraceAtFlag = &cli.StringFlag{
		...
		EnvVars:  []string{"VINITN_BACKTRACE"},
		Category: "LOGGING AND DEBUGGING",
	}
	...
	logFormatFlag = &cli.StringFlag{
		...
		Value:    "terminal",
		Aliases:  []string{},
		EnvVars:  []string{"VINITN_LOGFORMAT"},
		Category: "LOGGING AND DEBUGGING",
	}
	...
	logRotateFlag = &cli.BoolFlag{
		...
		Aliases:  []string{},
		EnvVars:  []string{"VINITN_LOGROTATE"},
		Category: "LOGGING AND DEBUGGING",
	}
	logMaxSizeMBsFlag = &cli.IntFlag{
		...
		Value:    100,
		Aliases:  []string{},
		EnvVars:  []string{"VINITN_LOGMAXSIZE"},
		Category: "LOGGING AND DEBUGGING",
	}
	logMaxBackupsFlag = &cli.IntFlag{
		...
		Value:    10,
		Aliases:  []string{},
		EnvVars:  []string{"VINITN_LOGMAXBACKUPS"},
		Category: "LOGGING AND DEBUGGING",
	}
	logMaxAgeFlag = &cli.IntFlag{
		...
		Value:    30,
		Aliases:  []string{},
		EnvVars:  []string{"VINITN_LOGMAXAGE"},
		Category: "LOGGING AND DEBUGGING",
	}
	logCompressFlag = &cli.BoolFlag{
		...
		Aliases:  []string{},
		EnvVars:  []string{"VINITN_LOGCOMPRESS"},
		Category: "LOGGING AND DEBUGGING",
	}
	...
	pprofPortFlag = &cli.IntFlag{
		...
		EnvVars:  []string{"VINITN_PPROFPORT"},
		Category: "LOGGING AND DEBUGGING",
	}
	pprofAddrFlag = &cli.StringFlag{
		...
		EnvVars:  []string{"VINITN_PPROFADDR"},
		Category: "LOGGING AND DEBUGGING",
	}
	memprofileFlag = &cli.StringFlag{
		...
		EnvVars:  []string{"VINITN_MEMPROFILE"},
		Category: "LOGGING AND DEBUGGING",
	}
	memprofilerateFlag = &cli.IntFlag{
		...
		EnvVars:  []string{"VINITN_MEMPROFILERATE"},
		Category: "LOGGING AND DEBUGGING",
	}
	blockprofilerateFlag = &cli.IntFlag{
		...
		EnvVars:  []string{"VINITN_BLOCKPROFILERATE"},
		Category: "LOGGING AND DEBUGGING",
	}
	cpuprofileFlag = &cli.StringFlag{
		...
		EnvVars:  []string{"VINITN_CPUPROFILE"},
		Category: "LOGGING AND DEBUGGING",
	}
